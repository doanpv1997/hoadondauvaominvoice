            ...
            <div className="menu-submenu">
              ...
              <ul className="menu-subnav">
                ...
                <li
                    ...
                    aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/e-commerce/dvt">
                    <i className="menu-bullet menu-bullet-dot">
                      <span/>
                    </i>
                    <span className="menu-text">Đơn vị tính</span>
                  </NavLink>
                </li>
                {/*end::2 Level*/}
                {/*begin::2 Level*/}
                <li
                    ...
                    aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/e-commerce/user">
                    <i className="menu-bullet menu-bullet-dot">
                      <span/>
                    </i>
                    <span className="menu-text">Danh mục người sử dụng</span>
                  </NavLink>
                </li>
                {/*end::2 Level*/}
                {/*begin::2 Level*/}
