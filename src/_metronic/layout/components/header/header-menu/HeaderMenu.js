    ...
    >
        ...
        <ul className={`menu-nav ${layoutProps.ulClasses}`}>
            ...
            <li
                ...
                aria-haspopup="true"
                className={`menu-item menu-item-submenu menu-item-rel ${getMenuItemActive('/cate')}`}>
                <NavLink className="menu-link menu-toggle" to="/cate">
                    <span className="menu-text"><FormattedMessage id="CATEGORY" /></span>
                ...
                <div className="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul className="menu-subnav">
                        {/*begin::2 Level*/}
                        <li
                            className={`menu-item menu-item-submenu ${getMenuItemActive('/category')}`}
                        ...
                        >
                            ...
                            <div className={`menu-submenu menu-submenu-classic menu-submenu-right`}>
                                <ul className="menu-subnav">
                                    {/*begin::3 Level*/}
                                    <li className={`menu-item ${getMenuItemActive('/category/dvt')}`}>
                                        <NavLink className="menu-link" to="/category/dvt">
                                            <i className="menu-bullet menu-bullet-dot"><span /></i>
                                            <span className="menu-text">Danh mục đơn vị tính</span>
                                        </NavLink>
                                    </li>
                                    {/*end::3 Level*/}

                                    {/*begin::3 Level*/}
                                    <li className={`menu-item ${getMenuItemActive('/category/khachhang')}`}>
                                        <NavLink className="menu-link" to="/category/khachhang">
                                            <i className="menu-bullet menu-bullet-dot"><span /></i>
                                            <span className="menu-text">Danh mục khách hàng</span>
                                        </NavLink>
                                    </li>
                                    {/*end::3 Level*/}
                                </ul>
                        ...
                        {/*begin::2 Level*/}
                        <li className={`menu-item ${getMenuItemActive('/hanghoa')}`}>
                            <NavLink className="menu-link" to="/hanghoa">
                                <span className="menu-text">Danh mục hàng hóa</span>
                            </NavLink>
                        </li>
                        {/*end::3 Level*/}
