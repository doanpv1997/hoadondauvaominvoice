...
export function SubHeader() {
  ...
  useLayoutEffect(() => {
    ...
    // set subheader nếu để aside thì put thên aside.breadcrumbs
    subheader.setBreadcrumbs(header.breadcrumbs);
      ...
      >
        ...
        <div className="d-flex align-items-center">
          <a href="#" className="btn btn-light btn-sm font-weight-bold" id="kt_dashboard_daterangepicker"
            ...
            <span className="text-primary font-weight-bold" id="kt_dashboard_daterangepicker_date">{(new Date()).toLocaleDateString('en-US')}</span>
          </a>
          <QuickActions />
        </div>
      </div>
